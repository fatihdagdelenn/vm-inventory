...
const I18N = {
  ...
  EN: {
    ...
    'ph.total': 'Total Devices', 'ph.add': 'Add Device', 'ph.edit': 'Edit Device',
    'ph.history': 'History', 'ph.historyTitle': 'Change History', 'ph.all': 'All',
    'ph.searchPh': 'Search name, IP, brand, model or serial no\u2026',
    'ph.type': 'Type', 'ph.name': 'Name', 'ph.location': 'Location', 'ph.status': 'Status',
    'ph.mgmtIp': 'Management IP', 'ph.iloIp': 'iLO/BMC IP', 'ph.brandModel': 'Brand / Model',
    'ph.specs': 'CPU / RAM', 'ph.brand': 'Brand', 'ph.model': 'Model', 'ph.serialNo': 'Serial No',
    'ph.cpu': 'CPU', 'ph.ram': 'RAM (GB)', 'ph.os': 'Operating System', 'ph.notes': 'Notes',
    'ph.serverOnly': 'Server-only hardware details',
    'ph.locationPh': 'e.g. Ankara DC / Rack A12', 'ph.brandPh': 'Dell, HPE, NetApp\u2026',
    'ph.modelPh': 'PowerEdge R750\u2026', 'ph.cpuPh': '2x Xeon Gold 6338 (64c)', 'ph.osPh': 'ESXi 8.0',
    'ph.date': 'Date', 'ph.action': 'Action', 'ph.changes': 'Changes',
    'ph.allLocations': 'All locations', 'ph.brandModel': 'Brand / Model',
    'ph.role': 'Role', 'ph.roleNone': '— Select —', 'ph.allRoles': 'All roles',
    ...
    'ph.d.server': 'Bare-metal, hypervisor', 'ph.d.storage': 'Disk array, NAS',
    'ph.d.san_switch': 'FC / iSCSI switch', 'ph.d.backup': 'Backup appliance',
    'ph.typeRequired': 'Please select a device type.',
    'ph.addedAs': '{ad} added as {tip}',
    'ph.emptyFiltered': 'No devices match this filter. The device you are looking for may have been added under a different type.',
    'ph.clearFilters': 'Clear filters',
    ...
    'ph.confirmDelete': 'Delete this device?',
    'ph.t.server': 'Physical Server', 'ph.t.storage': 'Storage',
    'ph.t.san_switch': 'SAN Switch', 'ph.t.backup': 'Backup Unit',
    'ph.s.active': 'Active', 'ph.s.passive': 'Passive', 'ph.s.faulty': 'Faulty',
    'ph.s.spare': 'Spare', 'ph.s.retired': 'Retired',
    'dash.physicalDevices': 'Physical Devices',
    'rp.physical': 'Physical', 'rp.allExport': 'All Inventory',
    'rp.scope': 'Scope', 'rp.format': 'Format',
    'rp.filterVmOnly': 'The filter applies to the Virtual Machines scope only.',
    'rp.scopeVms': 'Exports the virtual machine inventory.',
    'rp.scopeHosts': 'Exports the host inventory.',
    'rp.scopeDs': 'Exports the datastore inventory.',
    'rp.scopePhysical': 'Exports physical inventory (servers, storage, SAN switches, backup units).',
    'rp.scopeAll': 'All inventory in one file: VMs + hosts + datastores + physical. Excel uses separate sheets; CSV/PDF use stacked sections.',
    'rp.dailyAt': 'Every day at', 'rp.namePh': 'e.g. Daily prod report',
    'rp.schFilterPh': 'e.g. env:production status:running',
    'rp.filterVmScopes': 'The filter applies only to the Virtual Machines and All Inventory scopes.',
    'rp.next': 'Next', 'rp.last': 'Last',
    'rp.cleanup': 'Clean up', 'rp.cleanupConfirm': 'The newest 20 files will be kept, the rest deleted. Continue?',
    'rp.cleanedUp': '{n} old files deleted', 'rp.deleteFileConfirm': 'Delete this file?',
    'rp.moreFiles': 'Showing the {s} newest of {n} files total',
    'rp.allDesc': 'All inventory in one file (VMs + hosts + datastores + physical). Excel uses separate sheets; CSV/PDF use stacked sections.',
    'action.save': 'Save', 'action.cancel': 'Cancel', 'action.edit': 'Edit',
    'action.delete': 'Delete', 'hi.actor': 'User',
    ...
    'vm.diskTotal': 'Total', 'vm.diskCount': 'disks',
    'vm.diskUsedTotal': 'Real usage (VM-wide)',
    'vm.multiDisk': 'This VM has multiple disks \u2014 click for details',
