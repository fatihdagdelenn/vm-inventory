...
const I18N = {
  ...
  EN: {
    ...
    'dash.cycle': 'Cycle',
    'dash.noLocal': 'Exclude local disks',
    'dash.noLocalHint': 'Exclude node-local disks (local/local-lvm) from the disk gauges \u2014 real shared capacity', 'dash.cycleHint': 'Auto-rotate pages (monitoring)',
