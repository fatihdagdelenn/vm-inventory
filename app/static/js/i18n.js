...
const I18N = {
  ...
  EN: {
    ...
    'dash.cycle': 'Cycle',
    'dash.noLocalOn': 'Local disks hidden \u2014 click to show',
    'dash.noLocalHint': 'Hide node-local disks (local/local-lvm) from ALL disk gauges', 'dash.cycleHint': 'Auto-rotate pages (monitoring)',
